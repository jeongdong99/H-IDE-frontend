...
import { checkNickname } from '../../utils/api'; //api.js 에 작성하신 함수를 여기 import 해주셔야 합니다!
    ...
    <section className='flex flex-col justify-center mt-10 max-w-[550px] m-auto'>
        <div className='p-6 bg-[#F6FBF4] rounded-md shadow-lg'>
            <h1 className="flex flex-col items-center">
                <img src={insun_hidelogo} alt="Logo" className="w-[300px] h-[200px] flex self-center" />
            </h1>
        ...
        <form className='mt-6' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='mt-6 flex justify-center'>
                <button type='submit' className='bg-[#457D61] text-white px-20 py-2 text-sm font-semibold rounded-md hover:bg-[#2E5341] duration-200'> 닉네임 변경 완료 </button>
            </div>
        </form>
  </div>
</section>
